...
<div class="panel panel-flat bg-indigo border-left-xlg border-left-orange">
    <div class="panel-heading">
        ...
        <h5 class="panel-title">{{ $page }} <span class="label bg-{{ $symbol['color'] }} position-right">{{ $symbol['label'] }}</span></h5>
...
<div class="panel panel-flat bg-indigo border-left-xlg border-left-orange">
    <div class="panel-heading">
        <h5 class="panel-title">{{ $response_count . ' ' . str_plural('Respon', $response_count) }}</h5>
        <div class="heading-elements">
            <div class="heading-btn">
                <a href="{{ route('forms.responses.index', $form->code) }}" class="btn {{ ($response_type_shown_is_summary) ? 'bg-orange' : 'btn-default' }}">Seluruh</a>
                <a href="{{ route('forms.responses.index', [$form->code, 'type' => 'individual']) }}" class="btn {{ (!$response_type_shown_is_summary) ? 'bg-orange' : 'btn-default' }}">Individu</a>
            </div>
        </div>
    </div>
</div>
