        ...
        <div class="col-md-4 col-md-offset-4">
            ...
            @endif
                <div class="text-center">
                    <h5 class="content-group-lg">Silahkan masuk ke dalam DESForm </h5>
                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn bg-teal btn-block">Masuk <i class="icon-arrow-right14 position-right"></i></button>
                </div>

                <!-- <div class="content-divider text-muted form-group"><span>Don't have an account?</span></div> -->

                <!-- <a href="{{ route('register') }}" class="btn btn-default btn-block content-group">Buat Akun Baru</a> -->
                {{-- <a href="{{ route('admin.welcome') }}" class="btn btn-default btn-block content-group">Admin Login</a> --}}
            </div>
        </div>
    </div>
</form>
